...
Summary: Change easy the firmware on the usbprog adapter.

%description
Change easy the firmware on the usbprog adapter.
usbprog.spec.  Generated from usbprog.spec.in by configure.
Please edit usbprog.spec.in to add several more lines of description
