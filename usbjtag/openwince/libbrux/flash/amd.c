/*
 * $Id: amd.c,v 1.8 2003/09/23 17:48:40 telka Exp $
 *
...
amd_flash_print_info( cfi_array_t *cfi_array )
{
	...
	cid = bus_read( bus, adr+0x02) & 0xFFFF;
	prot = bus_read( bus, adr+0x05) & 0xFF;
	}else{
