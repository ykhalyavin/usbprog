# usbproglogic.spec
#
# Copyright (c) 2008 Benedikt Sauter sauter@ixbat.de
#
%define name usbproglogic
...
# optional items
#Vendor: Benedikt Sauter
#Distribution:
#Icon:
#URL:
#Packager: Benedikt Sauter sauter@ixbat.de
...
Summary: Record vcd files with usbprogLogic

%description
Record vcd files with usbprogLogic
usbproglogic.spec.  Generated from usbproglogic.spec.in by configure.
Please edit usbproglogic.spec.in to add several more lines of description
